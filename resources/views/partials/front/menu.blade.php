    ...
    <nav class="column--right">
      <ul class="menu__list--front menu__list list-inline">
        <li class="menu__item--front menu__item">
          <a class="menu__link--front menu__link" href="">A propos</a>
        </li>
        @if(!Auth::check())
        <li class="menu__item--front menu__item">
          <a class="menu__link--front menu__link" href="{{route("auth.connexion")}}">Connexion</a>
        </li>
        <li class="menu__item--front menu__item">
          <a class="menu__link--front menu__link" href="{{route("auth.inscription")}}">Inscription</a>
        </li>
      @endif
      ...
      <li class="menu__item--user">
        ...
        <ul class="user__menu hide">
          ...
          <li class="user__item--front user__item">
            <a class="user__link--front user__link" href="{{route("place.add")}}">Ajouter un musée</a>
          </li>
          <li class="user__item--front user__item">
            <a class="user__link--front user__link" href="{{route("user.show", ["id" => Auth::User()->id])}}">Mon profil</a>
          </li>

          <li class="user__item--front user__item">
            <a class="user__link--front user__link" href="{{route("compte.edit")}}">Réglages</a>
          </li>
        <li class="user__item--front user__item">
          <a class="user__link--front user__link" href="{{route("auth.logout")}}">Déconnexion</a>
        </li>
        </ul>
      </li>
    @endif
